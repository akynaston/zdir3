...
public class DeencryptTool {
     ...
     */
    public DeencryptTool(String keyVal) throws IdMUnitException {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        org.idmunit.EncTool em = new org.idmunit.EncTool("IDMUNIT1");
        System.out.println("encrypted password value: " + em.encryptCredentials("PUT PASSWORD HERE"));

        System.out.println("IdMUnit v." + Version.getVersion(org.idmunit.EncTool.class));
        if (args.length < 2) {
            displayInstructions();
            System.exit(-1);
        }
        try {
            org.idmunit.EncTool encryptionManager = new org.idmunit.EncTool(args[0]);
            System.out.println("Unencrypted password value: " + encryptionManager.decryptCredentials(args[1]));
